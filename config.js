...
// Auth information
global.pairNumber = "233532082279";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split ["233532082279"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split["233532082279"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split["233532082279"];
global.OwnerName = process.env.OWNER_NAME || "Yatti";
global.BotName = process.env.BOT_NAME || "Pandayatti";
